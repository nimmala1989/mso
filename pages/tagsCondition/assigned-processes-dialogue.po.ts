...
export class AssignedProcesses {
    ...
    async selectSamplingProcess(valueToSelect: string | number = 0) {
        await this.page.click('mat-select#smplProcess');
    ...
    async getSelectedValues() {
        return this.page.textContent('span div:has-text("Assigned Processes") ~ [class="form-row"]')
    }
